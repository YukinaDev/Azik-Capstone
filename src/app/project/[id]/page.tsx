...
export default function ProjectDetail() {
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-neutral-950">
        <div className="text-center">
          ...
          <Link
            href="/"
            className="text-lime-200 hover:text-white transition font-[var(--font-wolf)]"
          >
            ← Back to home
          </Link>
        </div>
  ...
  return (
    <div className="min-h-screen bg-neutral-950">
      ...
      <div className="pointer-events-none fixed inset-0 bg-gradient-to-br from-lime-400/10 via-transparent to-sky-500/10 mix-blend-screen" />
      ...
      <header className="sticky top-0 z-30 border-b border-white/10 bg-neutral-950/70 backdrop-blur-xl">
        <div className="flex items-center justify-between px-6 py-6 md:px-14">
          ...
          <Link
            href="/#contact"
            className="rounded-full border border-white/20 px-5 py-2 text-xs uppercase tracking-[0.2em] text-white/80 transition hover:border-lime-200/70 hover:text-white font-[var(--font-wolf)]"
          >
            Contact
          </Link>
        </div>
      ...
      <main ref={contentRef} className="relative z-10 px-6 py-16 md:px-14 lg:px-24">
        <div className="mx-auto max-w-6xl space-y-16">
          ...
          <div
            data-animate
            className="grid gap-8 rounded-3xl border border-white/10 bg-white/5 p-8 md:grid-cols-2 lg:grid-cols-4"
          >
            <div>
          ...
          >
            ...
            <Link
              href="/#contact"
              className="group flex items-center gap-3 rounded-full bg-lime-300 px-6 py-3 text-sm font-semibold text-neutral-950 transition hover:bg-white font-[var(--font-wolf)]"
            >
              Start a project
              <svg
                viewBox="0 0 24 24"
