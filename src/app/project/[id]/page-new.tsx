...
export default function ProjectDetail() {
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-[#0a0e27]">
        <div className="text-center">
          <h1 className="font-[var(--font-wolf)] text-4xl text-white mb-4">
            Project not found
          </h1>
          <Link
            href="/"
            className="text-[#5EC4F0] hover:text-white transition font-[var(--font-wolf)]"
          >
            ← Back to home
          </Link>
        </div>
  ...
  return (
    <div className="min-h-screen bg-[#0a0e27]">
      ...
      <div className="pointer-events-none fixed inset-0 bg-gradient-to-br from-[#5EC4F0]/15 via-[#1c215e]/5 to-[#5EC4F0]/10 mix-blend-screen" />

      <header className="sticky top-0 z-30 border-b border-[#5EC4F0]/20 bg-[#1c215e]/90 backdrop-blur-xl">
        <div className="flex items-center justify-between px-6 py-6 md:px-14">
          <Link
            href="/"
            className="group flex items-center gap-3 text-sm uppercase tracking-[0.3em] text-[#5EC4F0]/80 transition hover:text-white font-[var(--font-wolf)]"
          >
            <svg
              viewBox="0 0 24 24"
              fill="none"
          ...
          <Link
            href="/#contact"
            className="rounded-full border border-[#5EC4F0]/40 px-5 py-2 text-xs uppercase tracking-[0.2em] text-[#5EC4F0]/80 transition hover:border-[#5EC4F0] hover:bg-[#5EC4F0]/20 hover:text-white font-[var(--font-wolf)]"
          >
            Contact
          </Link>
        </div>
      ...
      <main ref={contentRef} className="relative z-10 px-6 py-16 md:px-14 lg:px-24">
        <div className="mx-auto max-w-6xl space-y-16">
          <div className="space-y-8" data-animate>
            ...
            <h1 className="font-[var(--font-wolf)] text-5xl md:text-6xl lg:text-7xl text-white">
              {project.title}
            </h1>
          ...
          <div
            data-animate
            className="grid gap-8 rounded-3xl border border-[#5EC4F0]/20 bg-gradient-to-br from-[#1c215e]/60 to-[#1c215e]/40 backdrop-blur-xl p-8 md:grid-cols-2 lg:grid-cols-4"
          >
            <div>
              <p className="text-xs uppercase tracking-[0.3em] text-[#5EC4F0]/60 font-[var(--font-wolf)]">
                Year
              </p>
              <p className="mt-2 text-xl text-white font-[var(--font-wolf)]">
                {project.year}
              </p>
            </div>
            <div>
          ...
          <div className="space-y-8">
            {project.images.map((image, index) => (
              <div
                key={index}
                data-animate
                className="overflow-hidden rounded-3xl border border-[#5EC4F0]/20 hover:border-[#5EC4F0]/50 transition-colors"
              >
                <Image
                  src={image}
          ...
          <div
            data-animate
            className="flex items-center justify-between border-t border-[#5EC4F0]/20 pt-8"
          >
            <Link
              href="/"
              className="group flex items-center gap-3 text-sm uppercase tracking-[0.3em] text-[#5EC4F0]/80 transition hover:text-white font-[var(--font-wolf)]"
            ...
            <Link
              href="/#contact"
              className="group flex items-center gap-3 rounded-full bg-[#5EC4F0] px-6 py-3 text-sm font-semibold text-[#1c215e] transition hover:bg-white hover:shadow-[0_0_30px_rgba(94,196,240,0.6)] font-[var(--font-wolf)]"
            >
              Start a project
              <svg
                viewBox="0 0 24 24"
