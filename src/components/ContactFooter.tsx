...
const socialLinks = [
  {
    name: "Instagram",
    handle: "@azik017.vha",
    href: "https://www.instagram.com/azik017.vha/",
    icon: (
  ...
  {
    name: "Behance",
    handle: "behance.net/hoanganhvu4",
    href: "https://www.behance.net/hoanganhvu4",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-6 w-6">
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12">
            ...
            <div className="relative space-y-12 px-8 py-16 md:p-20">
              ...
              <div data-contact-item className="flex flex-wrap gap-4">
                <a
                  href="mailto:eddieazik2303@gmail.com"
